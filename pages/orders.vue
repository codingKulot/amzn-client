              ...
              <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 text-left">
                  <div class="a-row">
                    ...
                    <br />
                    <span class="a-size-base a-text-bold a-color-secondary">February 17, 2020</span>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2">
                  <div class="a-row">
                    ...
                    <br />
                    <span class="a-size-base a-text-bold a-color-secondary">N/A</span>
                  </div>
                </div>
              ...
              <div v-for="product in order.products" :key="product._id">
                ...
                <div class="row">
                  <div class="col-xl-2 col-lg-2 col-2">
                    <!-- Product's image -->
                    <a href="#">
                      <img :src="product.productID.image" class="img-fluid" style="width: 100px;" />
                    </a>
                  </div>
