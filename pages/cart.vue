                    ...
                    <div class="a-row a-spacing-top-base a-spacing-base">
                      <div class="row">
                        ...
                        <div class="col-sm-2 col-2">
                          <nuxt-link :to="`/product/${product._id}`" class="a-link-normal">
                    ...
                    <span class="a-spacing-small a-button-primary a-button-icon">
                      <span class="a-button-inner">
                        <template v-if="$auth.$state.loggedIn">
                          <nuxt-link to="/place-order" class="a-button-text">Proceed to checkout</nuxt-link>
                        </template>
                        <template else>
                          <nuxt-link to="/login" class="a-button-text">Proceed to checkout</nuxt-link>
                        </template>
                      </span>
                    </span>
                  </div>
                        ...
                        <span class="a-list-item">
                          <div class="row">
                            <div class="col-md-4 col-sm-3 col-3 pl-0">
                              <a href="#">
                                <img src="img/rsz_video-games.jpg" class />
                              </a>
                            </div>
