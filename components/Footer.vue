  ...
  <footer>
    <div class="navLeftFooter">
      ...
      <div class="navFooterCopyright">
        ...
        <h6>DISCLAIMER: This Website is for demo purposes only. All images of trademarked, copyright, and/or patented material in this presentation is for informational and educational purposes only.</h6>
      </div>
    </div>
  </footer>
  <!--/FOOTER-->
