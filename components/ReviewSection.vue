            ...
            <span class="a-button-base writeReviewButton cm-cr-button-wide">
              <span class="a-button-inner">
                <template v-if="$auth.$state.loggedIn">
                  <nuxt-link :to="`/review/${product._id}`" class="a-button-text" role="button">Write a customer review</nuxt-link>
                </template>
                <template else>
                  <nuxt-link to="/login" class="a-button-text" role="button">Write a customer review</nuxt-link>
                </template>
              </span>
            </span>
          </div>
        ...
        <div class="col-lg-6 col-md-7 col-sm-12">
          <div class="reviews-image-gallery">
            ...
            <div class="a-spacing-small a-spacing-top-small">
              <img class="img-fluid customer-review-image" width="22.5%" v-for="review in reviews" :key="review._id" :src="review.image" />
            </div>
            <div>
